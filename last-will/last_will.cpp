...
int assemble_account_number(int secret_modifer) {
    return zhang::bank_number_part(secret_modifer)
         + khan::bank_number_part(secret_modifer)
         + garcia::bank_number_part(secret_modifer);
}

int assemble_code() {
    int red_total = zhang::red::code_fragment()
                  + khan::red::code_fragment()
                  + garcia::red::code_fragment();
    int blue_total = zhang::blue::code_fragment()
